...
{
    default String echoMsg(String msg)
    {
        return echoMsg(msg, com.zeroc.Ice.ObjectPrx.noExplicitContext);
    }

    default String echoMsg(String msg, java.util.Map<String, String> context)
    {
        return _iceI_echoMsgAsync(msg, context, true).waitForResponse();
    }

    default java.util.concurrent.CompletableFuture<java.lang.String> echoMsgAsync(String msg)
    {
        return _iceI_echoMsgAsync(msg, com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<java.lang.String> echoMsgAsync(String msg, java.util.Map<String, String> context)
    {
        return _iceI_echoMsgAsync(msg, context, false);
    }
     ...
     * @return -
     **/
    default com.zeroc.IceInternal.OutgoingAsync<java.lang.String> _iceI_echoMsgAsync(String iceP_msg, java.util.Map<String, String> context, boolean sync)
    {
        com.zeroc.IceInternal.OutgoingAsync<java.lang.String> f = new com.zeroc.IceInternal.OutgoingAsync<>(this, "echoMsg", null, sync, null);
